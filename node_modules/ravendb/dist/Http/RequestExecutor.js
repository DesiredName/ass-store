...
class RequestExecutor {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!TypeUtil_1.TypeUtil.isNullOrUndefined(timeout)) {
                    ...
                    try {
                        const response = yield this._send(chosenNode, command, sessionInfo, request);
    ...
    _createRequest(node, command, urlRef) {
        ...
        let builder = new url_1.URL(req.uri);
        ...
        if (command["getRaftUniqueRequestId"]) {
            ...
            builder = new url_1.URL(builder.toString() + joinCharacter + raftRequestString);
        }
...
RequestExecutor.GLOBAL_APPLICATION_IDENTIFIER = (0, uuid_1.v4)().toString();
