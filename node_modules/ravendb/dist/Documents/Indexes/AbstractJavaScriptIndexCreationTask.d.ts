...
export declare class AbstractJavaScriptIndexCreationTask<TDocument extends object, TMapResult extends object = any> extends AbstractGenericIndexCreationTask<keyof TMapResult & string> {
    private _map;
    private _reduce;
