...
class AbstractJavaScriptMultiMapIndexCreationTask extends AbstractGenericIndexCreationTask_1.AbstractGenericIndexCreationTask {
    constructor() {
        super();
        this._maps = [];
    ...
    reduce(mapReduce) {
        this._reduce = mapReduce(new StronglyTyped_1.IndexingGroupResults()).format();
    }
